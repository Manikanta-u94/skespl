...
(function($) {
    ...
    DESIGNJ.isMobile = {
        ...
        any: function() {
            return (DESIGNJ.isMobile.Android() || DESIGNJ.isMobile.BlackBerry() || DESIGNJ.isMobile.iOS() || DESIGNJ.isMobile.Opera() || DESIGNJ.isMobile.Windows());
        }
    };
    ...
    DESIGNJ.bmiCalculator = {
        ...
        calculateStandard: function (bmi_form) {
            ...
            var output = DESIGNJ.bmiCalculator.magic(bmi);
        ...
        init: function () {
            ...
            bmi_Standard_Form.on('submit', function(e) {
                e.preventDefault();
                DESIGNJ.bmiCalculator.calculateStandard(bmi_Standard_Form);
                return false;
            });
            ...
            bmi_Metric_Form.on('submit', function(e) {
                e.preventDefault();
                DESIGNJ.bmiCalculator.calculateMetric(bmi_Metric_Form);
                return false;
            });
        }
    ...
    DESIGNJ.initialize = {
        ...
        init: function() {
            DESIGNJ.bmiCalculator.init();
            DESIGNJ.initialize.TM_toggleNavSearchIcon();
            DESIGNJ.initialize.TM_fixedFooter();
            DESIGNJ.initialize.TM_datePicker();
            DESIGNJ.initialize.TM_ddslick();
            DESIGNJ.initialize.TM_sliderRange();
            DESIGNJ.initialize.TM_loadBSParentModal();
            DESIGNJ.initialize.TM_demoSwitcher();
            DESIGNJ.initialize.TM_platformDetect();
            DESIGNJ.initialize.TM_onLoadPopupPromoBox();
            DESIGNJ.initialize.TM_customDataAttributes();
            DESIGNJ.initialize.TM_parallaxBgInit();
            DESIGNJ.initialize.TM_resizeFullscreen();
            DESIGNJ.initialize.TM_prettyPhoto_lightbox();
            DESIGNJ.initialize.TM_nivolightbox();
            DESIGNJ.initialize.TM_fitVids();
            DESIGNJ.initialize.TM_YTPlayer();
            DESIGNJ.initialize.TM_equalHeightDivs();
        },
        ...
        TM_parallaxBgInit: function() {
            if (!DESIGNJ.isMobile.any() && $window.width() >= 800 ) {
    ...
    DESIGNJ.header = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                DESIGNJ.header.TM_fullscreenMenu();
                DESIGNJ.header.TM_sidePanelReveal();
                DESIGNJ.header.TM_sidePushPanelContent();
                DESIGNJ.header.TM_scroolToTopOnClick();
                DESIGNJ.header.TM_scrollToFixed();
                DESIGNJ.header.TM_sticky();
                DESIGNJ.header.TM_topnavAnimate();
                DESIGNJ.header.TM_scrolltoTarget();
                DESIGNJ.header.TM_navLocalScorll();
                DESIGNJ.header.TM_menuCollapseOnClick();
                DESIGNJ.header.TM_homeParallaxFadeEffect();
                DESIGNJ.header.TM_topsearch_toggle();
            }, 0);
    ...
    DESIGNJ.widget = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                DESIGNJ.widget.TM_shopClickEvents();
                DESIGNJ.widget.TM_fcCalender();
                DESIGNJ.widget.TM_verticalTimeline();
                DESIGNJ.widget.TM_verticalMasonryTimeline();
                DESIGNJ.widget.TM_masonryIsotop();
                DESIGNJ.widget.TM_pieChart();
                DESIGNJ.widget.TM_progressBar();
                DESIGNJ.widget.TM_funfact();
                DESIGNJ.widget.TM_odometerFunfact();
                DESIGNJ.widget.TM_instagramFeed();
                DESIGNJ.widget.TM_jflickrfeed();
                DESIGNJ.widget.TM_accordion_toggles();
                DESIGNJ.widget.TM_tooltip();
                //DESIGNJ.widget.TM_countDownTimer();
            }, 0);
    ...
    DESIGNJ.slider = {
        ...
        init: function() {
            ...
            var t = setTimeout(function() {
                DESIGNJ.slider.TM_typedAnimation();
                DESIGNJ.slider.TM_flexslider();
                DESIGNJ.slider.TM_owlCarousel();
                DESIGNJ.slider.TM_maximageSlider();
                DESIGNJ.slider.TM_bxslider();
                DESIGNJ.slider.TM_beforeAfterSlider();
            }, 0);
        ...
        TM_flexslider: function() {
            ...
            if ( $each_flex_slider.length > 0 ) {
                DESIGNJ.widget.TM_portfolioFlexSliderGalleryPopUpInit();
                $each_flex_slider.each(function() {
                    ...
                    $flex_slider.flexslider({
                        ...
                        start: function(slider){
                            ...
                            DESIGNJ.initialize.TM_magnificPopup_lightbox();
                            DESIGNJ.initialize.TM_prettyPhoto_lightbox();
                            DESIGNJ.initialize.TM_nivolightbox();
                        },
                        after: function(){
    ...
    /* ---------------------------------------------------------------------- */
    //document ready
    DESIGNJ.documentOnReady = {
        init: function() {
            DESIGNJ.initialize.init();
            DESIGNJ.header.init();
            DESIGNJ.slider.init();
            DESIGNJ.widget.init();
            DESIGNJ.windowOnscroll.init();
        }
    };

    //window on load
    DESIGNJ.windowOnLoad = {
        init: function() {
            var t = setTimeout(function() {
                DESIGNJ.initialize.TM_wow();
                DESIGNJ.widget.TM_twittie();
                DESIGNJ.initialize.TM_magnificPopup_lightbox();
                DESIGNJ.initialize.TM_preLoaderOnLoad();
                DESIGNJ.initialize.TM_hashForwarding();
                DESIGNJ.initialize.TM_parallaxBgInit();
            }, 0);
    ...
    //window on scroll
    DESIGNJ.windowOnscroll = {
        init: function() {
            $window.on( 'scroll', function(){
                DESIGNJ.header.TM_scroolToTop();
                DESIGNJ.header.TM_activateMenuItemOnReach();
                DESIGNJ.header.TM_topnavAnimate();
            });
        }
    };
    ...
    DESIGNJ.header.TM_menuzord();

    /* ---------------------------------------------------------------------- */
    /* ---------------------------- Call Functions -------------------------- */
    /* ---------------------------------------------------------------------- */
    $document.ready(
        DESIGNJ.documentOnReady.init
    );
    $window.on('load',
        DESIGNJ.windowOnLoad.init
    );
    $window.on('resize', 
        DESIGNJ.windowOnResize.init
    );

    //call function before document ready
    DESIGNJ.initialize.TM_preLoaderClickDisable();
